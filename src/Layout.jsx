    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <footer className="bg-[#0a0a0a] border-t border-[#d4af37]/20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
          ...
          {/* Mobile Contact Icons - Only visible on mobile */}
          <div className="md:hidden mt-12 pt-8 border-t border-white/10">
            <h4 className="text-[#d4af37] text-sm tracking-wider uppercase mb-6 text-center">Kontakt</h4>
            <div className="flex justify-center items-center gap-4 flex-wrap">
              <a 
                href="tel:+38267518587"
                className="w-14 h-14 border-2 border-[#d4af37]/30 flex items-center justify-center hover:border-[#d4af37] hover:bg-[#d4af37]/10 transition-all"
              >
